...
- Account creation is serialized through a PostgreSQL row lock and constrained by configurable daily and total registration ceilings. Client-facing failures use a generic capacity message rather than exposing current account counts.
